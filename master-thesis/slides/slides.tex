  ...
  \begin{frame}{ Simulador e Infraestrutura de Coreografias }
	...
	\item <3-> Open Knowledge (A. Barker et al. 2009):
	    \begin{itemize}
	      ...
	      \item \color{red}{Roda coreografias de maneira limitada por conta do LCC}.%além que é do escopo acadêmico
	...
	\item <3-> BPEL gold (L. Engler 2009):
	    \begin{itemize}
	      ...
	      \item \color{red}{A implementação  é um protótipo}.%além que é do escopo acadêmico
	      %\item \color{red}{Roda coreografias de maneira limitada por conta do LCC}.
	    \end{itemize}  
     \end{itemize}
...
%\colorbox{red!25}{$3.10\%$}
  ...
  \begin{frame}{Resultados da detecção de violações de SLA (I)} 
	  ...
	  \begin{figure}[H]
	      \centering
	      \includegraphics[width=1.0\linewidth]{figures/KS-Comparison_1.png}
	  ...
	  \begin{figure}[H]
	      \centering
	      \includegraphics[width=1.0\linewidth]{figures/KS-Comparison_2.png}
