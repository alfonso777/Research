...
\begin{itemize}
 ...
 \item \textbf{Oceanologia}: Predições no oceano.
...
fluxos de trabalho complexos com uso intensivo de dados, a abordagem da coreografia pode melhorar vários aspectos deles.
 ...
 \subsection*{Uma rede de valor de negócio}
...
capaz de fazer a sua tarefa por meio da contratação de  dois serviços, o \textit{Blog-Service} e o \textit{MMS-Service}. O  \textit{Blog-Service}
