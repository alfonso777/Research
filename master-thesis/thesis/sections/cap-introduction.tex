...
pesquisa.%, porque antes disso, é fundamental detectar as falhas por meio do monitoramento da coreografia. %para realizar uma adaptação ou  uma auto-cura (\textit{self-healing}). %Também não inclui predição de QoS baseado no histórico, mas isto será
 ...
 \begin{itemize}
    ...
    \item O projeto Baile~\footnote{\url{http://ccsl.ime.usp.br/baile/}} - Habilitando coreografias escaláveis de serviços na núvem.
...
Em seguida, no Capítulo~\ref{cap:chor_scenarios} apresenta alguns cenários onde podem ser aplicadas as coreografias de serviços. 
