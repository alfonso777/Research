...
Na definição de requisitos de QoS em coreografias apresentou-se uma nova metodologia para avaliar o impacto da QoS por meio de simulações em uma GSPN. A
 ...
 Desse modo, conseguiu-se achar falhas na comunicação, na integridade das mensagens e gargalos em diversos pontos das interações entre serviços em etapas
antecipadas como a modelagem.  


Os objetivos foram atingidos por meio de simulações de coreografias. Construiu-se um simulador de coreografias com suporte de QoS chamado de  \textit{ChorSim}.  
 ...
 e possui um monitoramento para acompanhar a execução das instâncias
de coreografias. Dessa maneira, foi possível simular comportamentos que atualmente não podem ser realizados pela falta de implementações
...
Atualmente o simulador de coreografias já suporta o estabelecimento do
tempo de processamento nos serviços por meio de 
...
permite calcular quão próxima uma distribuição qualquer está de outra. Os resultados nessa última etapa foram consistentes 
...
emergente e há poucos trabalhos com relação a QoS.
